      ...
      <div className={Styles.page}>
        ...
        <section className={`${Styles.hero} ${Styles.reveal}`}>
          <div className={Styles.heroText}>
            <h1>
              Гидропривод <span>ГП</span>
            </h1>

            <p>
              Используется для создания гидравлического давления в силовом
              цилиндре многоходового переключателя скважин ПСМ.
            </p>
        ...
        <section className={`${Styles.features} ${Styles.reveal}`}>
          ...
          <div className={Styles.featuresGrid}>
            {[
              [
                "Надежность",
                "Стабильная работа в составе автоматизированных установок.",
              ],
              [
                "Высокая мощность",
                "Создает необходимое гидравлическое давление для работы ПСМ.",
              ],
              [
                "Долговечность",
              ...
              [
                "Совместимость",
                "Полностью совместим с переключателями скважин ПСМ.",
              ],
            ].map(([title, text], i) => (
        ...
        <section className={`${Styles.tech} ${Styles.reveal}`}>
          ...
          <div className={Styles.techText}>
            ...
            <p>
              Гидропривод создает давление в силовом гидравлическом цилиндре,
              которое обеспечивает перемещение механизма переключателя
              скважин ПСМ и его надежную работу в системе.
            </p>
